...
public class ShootEnemy4 : MonoBehaviour
{
    ...
    private void FireProjectile()
    {
        ...
        GameObject projectile = Instantiate(projectilePrefab, shootingPoint.position + offset * 1f, rotation);
        Rigidbody2D rb = projectile.GetComponent<Rigidbody2D>();
        rb.velocity = direction.normalized * projectileSpeed;
        GameObject projectile2 = Instantiate(projectilePrefab, shootingPoint.position + offset * 1f, rotation);
        Rigidbody2D rb2 = projectile2.GetComponent<Rigidbody2D>();
        rb2.velocity = (direction.normalized + new Vector3(0, 1)) * projectileSpeed;
        GameObject projectile3 = Instantiate(projectilePrefab, shootingPoint.position + offset * 1f, rotation);
        Rigidbody2D rb3 = projectile3.GetComponent<Rigidbody2D>();
        rb3.velocity = (direction.normalized + new Vector3(0, -1)) * projectileSpeed;
    }
